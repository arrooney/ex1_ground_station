...
#define CMD_ERROR_RICHAMBIG	(-105)
...
/* Memory sections */
#ifdef __linux__
#define __root_command __attribute__ ((section("commands"), used))
#else
#define __root_command __attribute__ ((section(".commands"), used))
#endif
...
typedef int (*command_completer_t)(char *line);
