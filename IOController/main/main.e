...
# 1 "../IOHook/IOHook.h" 1
# 26 "../IOHook/IOHook.h"
# 1 "../../CObject/liba/util/CCThreadedQueue.h" 1
# 25 "../../CObject/liba/util/CCThreadedQueue.h"
# 1 "../../CObject/liba/Class/Class.h" 1
# 30 "../../CObject/liba/Class/Class.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/5/include/stddef.h" 1 3 4
...
# 31 "../../CObject/liba/Class/Class.h" 2
...
# 283 "../../CObject/liba/Class/Class.h"
struct CObject
{
...
# 426 "../../CObject/liba/Class/Class.h"
void CInterface( void* self, void* iface, const void* vtable );
# 485 "../../CObject/liba/Class/Class.h"
void* CObjectCast_( void* super_reference, const char* file_name, int line_num );
# 508 "../../CObject/liba/Class/Class.h"
void CVTable( void* self, const void* vtable);
# 542 "../../CObject/liba/Class/Class.h"
const void* CGetVTable( void* self_ );
# 26 "../../CObject/liba/util/CCThreadedQueue.h" 2
# 1 "../../CObject/liba/Class/CError.h" 1
# 22 "../../CObject/liba/Class/CError.h"
typedef enum
{
 COBJ_OK = 0,
 COBJ_ALLOC_FAIL = 1,
...
# 27 "../../CObject/liba/util/CCThreadedQueue.h" 2
# 1 "../../CObject/liba/util/CIQueue.h" 1
# 43 "../../CObject/liba/util/CIQueue.h"
typedef enum
{
 CIQUEUE_OK = 0,
...
# 70 "../../CObject/liba/util/CIQueue.h"
struct CIQueue
{
...
# 26 "../../CObject/liba/util/COS.h" 2

typedef unsigned int COS_Timemsec;
# 29 "../../CObject/liba/util/CCThreadedQueue.h" 2
...
# 32 "../../CObject/liba/util/CCThreadedQueue.h" 2
# 52 "../../CObject/liba/util/CCThreadedQueue.h"
...
# 104 "../../CObject/liba/util/CCThreadedQueue.h"
...
# 125 "../../CObject/liba/util/CCThreadedQueue.h"
...
void* terminal_input_thread( void* arg )
{
 ...
 for( ;; ) {
  msg = getchar_fp( );
  CCThreadedQueue_Insert(gomshell_input, &msg, 
# 62 "main.c" 3 4
                                              (0x7fffffff * 2U + 1U)
# 62 "main.c"
                                                               );
...
void* terminal_output_thread( void* arg )
{
 ...
 for( ;; ) {
  CCThreadedQueue_Remove(gomshell_output, &msg, 
# 81 "main.c" 3 4
                                               (0x7fffffff * 2U + 1U)
# 81 "main.c"
                                                                );
...
int main( int argc, char** argv )
{
 ...
 pthread_create(&gomshell_thread_handle, 
# 101 "main.c" 3 4
                                        ((void *)0)
# 101 "main.c"
                                            , gomshell_thread, 
...
# 101 "main.c"
 ...
 pthread_create(&terminal_input_thread_handle, 
# 102 "main.c" 3 4
                                              ((void *)0)
# 102 "main.c"
...
# 102 "main.c"
 ...
 pthread_create(&terminal_output_thread_handle, 
# 103 "main.c" 3 4
                                               ((void *)0)
# 103 "main.c"
                                                   , terminal_output_thread, 
# 103 "main.c" 3 4
                                                                             ((void *)0)
# 103 "main.c"
                                                                                 );
 pthread_join(gomshell_thread_handle, 
# 104 "main.c" 3 4
                                     ((void *)0)
# 104 "main.c"
                                         );
